...
public class FunctionalTest {
	...
	// Provide the path to the TernaryOperatorAssignment class file
	String filePath = "src/main/java/com/yaksha/assignment/TernaryOperatorAssignment.java";
	...
	@Test
	public void testTernaryOperatorOnly() throws Exception {
		AutoGrader autoGrader = new AutoGrader();
		boolean result = autoGrader.testTernaryOperatorOnly(filePath);
